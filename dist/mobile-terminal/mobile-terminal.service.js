...
exports.MobileTerminalService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let MobileTerminalService = class MobileTerminalService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async getTopStatistics() {
        ...
        const riskControllerTotalAmount = allLoanAccounts.reduce((sum, account) => sum + this.toNumber(account.handling_fee) + this.toNumber(account.receiving_amount) - this.toNumber(account.company_cost), 0);
        ...
        const collectorTotalReduction = allCollectorAssets.reduce((sum, asset) => sum + this.toNumber(asset.reduced_handling_fee) + this.toNumber(asset.reduced_fines), 0);
        const allRiskControllerAssets = await this.prisma.riskControllerAssetManagement.findMany({
            select: { reduced_amount: true },
        });
        const riskControllerTotalReduction = allRiskControllerAssets.reduce((sum, asset) => sum + this.toNumber(asset.reduced_amount), 0);
...
exports.MobileTerminalService = MobileTerminalService;
exports.MobileTerminalService = MobileTerminalService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], MobileTerminalService);
//# sourceMappingURL=mobile-terminal.service.js.map